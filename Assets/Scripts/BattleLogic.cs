    ...
    private void InstantiateRandomCharactersOntoSpawnPositions( CharacterStats[] characterLibrary, Transform[] spawnPositions, List<CharacterStats> activeList )
    {
        ...
        */
        ...
        foreach( Transform sp in spawnPositions )
        {
            ...
            int randomInt = Random.Range(0, characterLibrary.Length);
            CharacterStats newCharacter = Instantiate(characterLibrary[randomInt]);
    ...
    private void Fight()
    {
        ...
        */
        ...
        if (Random.value > 0.5f)
        {
            ...
            //monster.MonsterAnimator.SetBool("takedamage_animation", true);
            //delay
            //monster.MonsterAnimator.SetBool("takedamage_animation", false);
            // Check hero health.
            if (hero.health <= 0f)
            {
        ...
        else
        {
            ...
            if (monster.health <= 0f)
            {
                ...
                monster.MonsterAnimator.SetBool("death_animation", true);
